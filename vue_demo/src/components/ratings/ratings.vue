...
<div class="ratings" ref="ratings">
  ...
  <split></split>
  <ratingSelect v-on:selectType="typeChange" v-on:toggle="contentChange" :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="ratings"></ratingSelect>
